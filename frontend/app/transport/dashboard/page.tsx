...
// "My Profile" and "Bookings" (Step 21 — Transport Hiring) are both real
// modules now, mirrors tractor's dashboard items.
const DASHBOARD_ITEMS: DashboardItem[] = [
  {
    key: "profile",
    label: "My Profile",
    description: "Vehicle type, capacity, rates, location, and availability",
  ...
  },
  {
    key: "bookings",
    label: "Bookings",
    description: "See farmers who want to book your vehicle",
  ...
  return (
    <main className={styles.page}>
      <div className={styles.container}>
        ...
        <h1 className={styles.title}>Transport Provider Dashboard</h1>
